...
--  CREATE OR REPLACE FUNCTION insertar_lector() RETURNS trigger AS $$
--      BEGIN
--          NEW.numero = 'L-'||NEW.id;
...
--  CREATE TRIGGER insertar_lector BEFORE INSERT ON lectores FOR 
--  EACH ROW EXECUTE PROCEDURE insertar_lector();
